    ...
    <section class="conten">
    	...
    	<table class="table">
    		...
    		<tr>
               ...
               <td><?php echo anchor('Warehousedtl/detail/'.$dtl->id,'<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>')?></td>
                <td onclick="javascript: return confirm('Anda Yakin Ingin Menghapus?') "><?php echo anchor('Warehousedtl/hapus/'.$dtl->id,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                <td><?php echo anchor('Warehousedtl/edit/'.$dtl->id,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td> 
    		</tr>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <!--Methode Tambah Aksi = Insert (Controller Detailwhs) Funnction (Tambah Aksi)-->
                        <form action="<?= base_url('warehousedtl/tambah_aksi') ?>" method="post">
                    </div>
