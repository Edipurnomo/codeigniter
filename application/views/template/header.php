        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url()?>asset/dist/img/Untitled.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Edi Purnomo</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url()?>asset/dist/img/Untitled.png" class="img-circle" alt="User Image">

                <p>
                  Edi Purnomo- Web Developer
